...
<head>
  ...
  <title>Pengaduan&AspirasiSiswa</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ ('assets\img\smp2.png') }}" rel="icon">
  <link href="{{ ('assets\img\smp2.png') }}" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Penasi</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#gallery">Alur Pengaduan</a></li>
          <li><a class="nav-link scrollto" href="#faq">F.A.Q</a></li>
          <li><a class="nav-link scrollto" href="#testimonials">Kontak</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            <h1>Selamat Datang di Website Pengaduan & Aspirasi Siswa<br>
              SMP Negeri 2 Cianjur</h1>
           <!-- <a href="#" class="download-btn"><i class="bx bxl-play-store"></i> Google Play</a> -->
           <!-- <a href="#" class="download-btn"><i class="bx bxl-apple"></i> App Store</a> -->
          </div>
        </div>
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <img src="assets/img/penasi.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
    ...
    <section id="tentang" class="tentang">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Tentang</h2>
          <p>Bimbingan konseling di Sekolah merupakan proses membantu kepada siswa untuk mencapai pemahaman dan pengarahan diri yang dilakukan dalam rangka menyesuaikan diri kepada sekolah.
          Pada Bimbingan yang dilakukan, siswa dapat melakukan Pengaduan terhadap apa yang dirasakan dan dialami maupun pengajuan Aspirasi. </p>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>PENASI SMPN2CJR</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://www.smpn2cianjur.sch.id/">SMP Negeri 2 Cianjur</a>
      </div>
    </div>
  </footer><!-- End Footer -->
